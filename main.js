    ...
    if(currentLocation > 1) {
        switch(currentLocation) {
            case 2:
                ...
                paper1.style.zIndex = 29;
                break;
            case 3:
                paper2.classList.remove("flipped");
                paper2.style.zIndex = 28;
                break;
            case 4:
                paper3.classList.remove("flipped");
                paper3.style.zIndex = 27;
                break;
            case 5:
                paper4.classList.remove("flipped");
                paper4.style.zIndex = 26;
                break;
            case 6:
                paper5.classList.remove("flipped");
                paper5.style.zIndex = 25;
                break;
            case 7:
                paper6.classList.remove("flipped");
                paper6.style.zIndex = 24;
                break;
            case 8:
                paper7.classList.remove("flipped");
                paper7.style.zIndex = 23;
                break;
            case 9:
                paper8.classList.remove("flipped");
                paper8.style.zIndex = 22;
                break;
            case 10:
                paper9.classList.remove("flipped");
                paper9.style.zIndex = 21;
                break;
            case 11:
